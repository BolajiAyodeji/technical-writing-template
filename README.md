...
In this section, you are to list out all the things your reader should do or have before reading your article. This is always useful to ensure your reader(s) can follow along without missing out at any section of the article. Please note that this should not be only practised with articles that entail some installation setup but any kind of article sue to something they don't have which you have on your own end. It can just be as minimal as asking your reader(s) to grab cold water before reading the article. A great way to get them ready, yeah?
...
In this section, you are to break your article into parts and list them out as bullets or checklists. This will allow you to write in a more organized manner and enable your reader(s) to read in an orderly manner. Ensure to link each prerequisite item to their respective heading in the article.
